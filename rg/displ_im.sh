...
do
    ...
    ../edisplace.exe $pdb ../$im_1 $file_vec1_20 5
    ../edisplace.exe $pdb ../$im_1 $file_vec1__20 -5

    ../edisplace.exe $pdb ../$im_2 $file_vec2_20 5
    ../edisplace.exe $pdb ../$im_2 $file_vec2__20 -5
