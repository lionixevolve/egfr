...
cmd.load("1M14_A.pdb")
cmd.load("3_modo2_1M14_A.pdb")
cmd.load("3_modo1_1M14_A.pdb")
cmd.load("modevectors.py")
modevectors("1M14_A", "3_modo1_1M14_A", outname="1modo", head=0.5, tail = 0.3, cut=0.5, headrgb = "1.0, 0.0, 0.2", tailrgb = "1.0, 0.0, 0.2") 
modevectors("1M14_A", "3_modo2_1M14_A", outname="2modo", head=0.5, tail = 0.3, cut=0.5, headrgb = "0.2, 0.0, 1.0", tailrgb = "0.2, 0.0, 1.0") 
...
cmd.png("aafig9_1m14.png", width=900, height=1100, dpi=600, ray=1)
