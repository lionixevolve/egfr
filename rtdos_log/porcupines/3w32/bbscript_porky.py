...
cmd.load("3_modo2_3W32_A.pdb")
cmd.load("modevectors.py")

modevectors("3W32_A", "3_modo1_3W32_A", outname="1modo", head=0.5, tail = 0.3, cut=0.5, headrgb = "1.0, 0.0, 0.2", tailrgb = "1.0, 0.0, 0.2") 
modevectors("3W32_A", "3_modo2_3W32_A", outname="2modo", head=0.5, tail = 0.3, cut=0.5, headrgb = "0.2, 0.0, 1.0", tailrgb = "0.2, 0.0, 1.0")
...
cmd.png("bb9fig_3w32.png", width=900, height=1100, dpi=600, ray=1)
