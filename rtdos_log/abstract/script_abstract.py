...
cmd.color("forest", "nlobe")
cmd.color("marine", "clobe")
cmd.color("firebrick", "aloop")

cmd.load("cavidad_1.pdb")
cmd.color("deepsalmon", "cavidad_1")
cmd.show("spheres", "cavidad_1")
cmd.set("sphere_scale", 0.65, "all")
...
#cmd.png("abstract.png", width=1100, height=1100, dpi=600, ray=1)
