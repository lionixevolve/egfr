...
C de el RMSD  
      ...
      character*50 infile_a, infile_b, outfile_a, outfile_b
      character*5 str_lenc1, str_lenc2

C****LA Kb ESTA EN ANGSTROMS CUADRADO

      call getarg(1, infile_a)!					toda esta parte es p/ nombrar a los archivos 
      call getarg(2, infile_b)
      call getarg(3, outfile_a)
      call getarg(4, outfile_b)
